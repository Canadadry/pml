...
type Drawer interface {
	...
	Image(imagePath string, x float64, y float64, width float64, height float64)
	Vector(vectorPath string, x float64, y float64, width float64, height float64) error
